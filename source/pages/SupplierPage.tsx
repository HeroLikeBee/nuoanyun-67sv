  ...
  return (
    <>
      <PageHead
        ...
        actions={<><Btn onClick={() => toast('已导出供应商台账')}>导出</Btn><Btn onClick={() => go('settings')} title="准入资料清单与黑名单规则见系统设置"><Ico n="gear" size={16} /> 准入规则</Btn><Btn kind="primary" onClick={() => { setNewOpen(true); resetNewSup(); }}>+ 新增供应商</Btn></>}
      />
